export const BIP39_WORDS: readonly string[] = [
  ...
  "always", "amazing", "among", "amount", "amused", "analyst", "anchor", "angel", "anger", "angle",
  ...
  "fog", "foil", "fold", "follow", "food", "foot", "force", "foreign", "forest", "forget",
  ...
  "player", "pleasure", "plenty", "plot", "plug", "plunge", "poem", "poet", "point", "polar",
