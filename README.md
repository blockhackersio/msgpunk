...
The server never — **never** — sees plaintext. Not the form structure. Not the password. Not the submission. Not a single byte of user data.
...
- **SLIP-10 / Ed25519** — self-sovereign key derivation from BIP-39
...
>
> This is the form service for the post-Snowden web. Self-sovereign. Stateless. Server-blind.
>
