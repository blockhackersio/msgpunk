...
import type { QuestionConfig, ThemeConfig, Json } from '../types'
      ...
      {value ? (
        ...
        <div>
          <motion.button
            ...
            className="w-full p-8 rounded-xl border-2 border-dashed flex flex-col items-center gap-3 transition-colors cursor-pointer"
            style={{
          ...
          {['Yes', 'No'].map((option) => {
            ...
            return (
              <motion.button
                ...
                className="flex-1 flex items-center justify-center gap-3 p-5 rounded-xl border-2 transition-all cursor-pointer"
                style={{
                  borderColor: isSelected ? theme.primaryColor : `${theme.textColor}20`,
                  backgroundColor: isSelected ? `${theme.primaryColor}10` : 'transparent',
                  color: theme.textColor,
            ...
            return (
              ...
              >
                <Star
                  ...
                  style={{ color: isActive ? theme.primaryColor : `${theme.textColor}30` }}
                />
              </motion.button>
            )
          })}
          ...
          {Array.from({ length: maxScale - minScale + 1 }).map((_, index) => {
            ...
            return (
              <motion.button
                ...
                className="w-12 h-12 md:w-14 md:h-14 rounded-xl border-2 flex items-center justify-center text-lg font-medium transition-all cursor-pointer"
                style={{
    ...
    case 'file_upload':
      return (
        <FileUploadQuestion
          ...
          onChange={onChange as (value: FileUploadValue | null) => void}
          theme={theme}
        />
      )
